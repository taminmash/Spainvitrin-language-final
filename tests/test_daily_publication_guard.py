...
from telegram_daily_entrypoint import MADRID_TZ, last_successful_publication_date, should_publish_today
...
class DailyPublicationGuardTests(unittest.TestCase):
    ...
    def test_history_timestamps_are_converted_to_madrid(self) -> None:
        progress = {
            "history": [
